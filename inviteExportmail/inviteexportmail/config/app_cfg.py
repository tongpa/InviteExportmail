# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in inviteExportmail.
...
import inviteexportmail
from inviteexportmail import model, lib
...
base_config.package = inviteexportmail
...
base_config.model = inviteexportmail.model
base_config.DBSession = inviteexportmail.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "1a1b0567-fc81-4fa0-a7c2-7472af34ca35"
