...
class RootController(BaseController):
    """
    The root controller for the inviteExportmail application.
    ...
    @expose('inviteexportmail.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('inviteexportmail.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('inviteexportmail.templates.data')
    @expose('json')
    def data(self, **kw):
        """
    ...
    @expose('inviteexportmail.templates.login')
